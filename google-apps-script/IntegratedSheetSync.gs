...
function checkHeaderIntegrity() {
  try {
    // setupHeaders関数のヘッダー配列を取得（実用的フィールド名）
    const headers = [
      'ID', 'タイトル', '内容', 'カテゴリ', '都道府県', '市町村', 'タグ', '募集開始日', '募集終了日',
      '公開状況', '最終更新', '実施組織', '組織タイプ', '応募対象', '申請手順', '連絡先', 
      '公式サイト', '地域条件', '申請ステータス', '提出書類', '採用率（%）', '難易度', '補助対象経費', 
      '補助率', '作成者', '公開日', '概要', 'サムネイル画像', '投稿URL', '最低金額',
      '最高金額', '発表日', '実施期間', 'シート更新日'
    ];
